  ...
  return (
    <div className={`${className} lts-component flex flex-col gap-1`}>
      ...
      <div className="w-full">
        <select value={value} onChange={({ target }) => (!disabled && !readonly ? onUpdateValue(target.value) : null)} className={`${error ? "!border-negative-100" : ""}`} placeholder={placeholder} disabled={disabled} readOnly={readonly}>
